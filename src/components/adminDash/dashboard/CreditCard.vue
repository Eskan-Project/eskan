<template>
    ...
    <div class="w-full mt-2  bg-white shadow rounded-xl p-6 shadow-lg">

      <div class="flex  items-center mb-4">
       
        <div class="text-xl font-bold text-gray-700">VISA</div>
      </div>
      ...
      <div class="flex flex-col justify-between  mb-3">
        <div class="text-sm text-gray-600">Credit Details</div>
        <div class="text-lg font-semibold text-gray-700">42424 4242 4242 4242</div>
