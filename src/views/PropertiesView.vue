<template>
  <div class="properties">
    <div class="relative w-full mx-auto h-[350px] bg-cover bg-center" :style="{ backgroundImage: `url(${bgImage})` }">
    ...
    <div class="container mx-auto py-10 px-5">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <PropertyCard v-for="(property, index) in paginatedProperties" :key="index" :property="property" />
      </div>
      <div class="flex justify-center mt-10 text-gray-500">
        <button class="px-3 py-2 border rounded-md mx-1" @click="prevPage" :disabled="currentPage === 1">Previous</button>
        <button v-for="page in visiblePages" :key="page" class="px-3 py-2 border rounded-md mx-1" :class="{ 'bg-gray-300': page === currentPage }" @click="goToPage(page)">
          {{ page }}
        </button>
        <button class="px-3 py-2 border rounded-md mx-1" @click="nextPage" :disabled="currentPage === totalPages">Next</button>
      </div>
    </div>
  </div>
</template>
...
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage3 },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage4 },
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage1 },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage2 },
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage3 },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage4 },
...
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage3 },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage4 },
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage },
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage },
{ title: "Apartment for sale", location: "London, Oxford St.", price: "290,000", size: "150", rooms: "3", units: "10", image: propertyImage },
{ title: "Luxury Condo", location: "New York, Times Sq.", price: "450,000", size: "180", rooms: "4", units: "5", image: propertyImage },
