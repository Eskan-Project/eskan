...
<template>
  <div class="properties">
    <div class="relative w-full mx-auto h-[380px] bg-cover bg-center" :style="{ backgroundImage: `url(${bgImage})` }">
      ...
      <div class="relative z-10 flex justify-center items-center h-full w-full max-w-4xl text-gray-500 mx-auto p-4">
        <div 
          ...
          :class="{
            ...
            'bg-transparent top-1/2 transform -translate-y-1/2': !isScrolled && !isExpanded
          }"
        >
          <div class="flex justify-center items-center ">
            ...
            >
              <input type="text" placeholder=" Search by keyword" class="border px-2 py-2 rounded-md text-sm">
              <select class="hover:bg-gray-500 hover:text-white p-2 rounded-md text-sm">
              ...
              <button class="bg-black text-white px-4 py-2 rounded-md transition hover:bg-gray-800">
                Search
              </button>
            </div>
            <div 
            ...
            >
              <div class="border rounded-full flex items-center p-2 bg-white shadow-md">
                <span class="px-2">Anywhere</span>
                <span class="px-2">Any week</span>
                <span class="px-2">Add guests</span>
                <button class="bg-[#364365] text-white rounded-full w-8 h-8 ml-2 transition-transform duration-300 hover:scale-110" @click="toggleSearch">
                  Q
                </button>
              </div>
            </div>
